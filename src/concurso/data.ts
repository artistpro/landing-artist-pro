...
export const CRONOGRAMA_EVENTO = [
  ...
  { fecha: '16 - 25 Septiembre 2026', titulo: 'Selección de Finalistas por Jurado', desc: 'Revisión técnica de materiales y selección de los finalistas por categoría.' },
...
export const MUNICIPIOS: MunicipioData[] = [
  ...
  { nombre: 'Marsella', departamento: 'Risaralda', destacado: true },
  { nombre: 'Belén de Umbría', departamento: 'Risaralda', destacado: true },
  { nombre: 'Apía', departamento: 'Risaralda', destacado: true },
  { nombre: 'Santuario', departamento: 'Risaralda', destacado: true },
  { nombre: 'Pueblo Rico', departamento: 'Risaralda', destacado: true },
  { nombre: 'Balboa', departamento: 'Risaralda', destacado: true },
  ...
  { nombre: 'Anserma', departamento: 'Caldas', destacado: true },
  { nombre: 'Riosucio', departamento: 'Caldas', destacado: true },
  ...
  { nombre: 'Viterbo', departamento: 'Caldas', destacado: true },
  { nombre: 'Belalcázar', departamento: 'Caldas' },
  { nombre: 'Risaralda (Caldas)', departamento: 'Caldas' },
  ...
  { nombre: 'Circasia', departamento: 'Quindío', destacado: true },
  { nombre: 'Montenegro', departamento: 'Quindío', destacado: true },
  { nombre: 'Quimbaya', departamento: 'Quindío', destacado: true },
  { nombre: 'Filandia', departamento: 'Quindío', destacado: true },
  { nombre: 'La Tebaida', departamento: 'Quindío' },
  { nombre: 'Córdoba', departamento: 'Quindío' },
  ...
  { nombre: 'Ansermanuevo', departamento: 'Norte del Valle', destacado: true },
  { nombre: 'El Cairo', departamento: 'Norte del Valle', destacado: true },
  { nombre: 'Argelia', departamento: 'Norte del Valle', destacado: true },
  { nombre: 'El Águila', departamento: 'Norte del Valle', destacado: true },
  { nombre: 'Versalles', departamento: 'Norte del Valle', destacado: true },
  { nombre: 'El Dovio', departamento: 'Norte del Valle' },
  { nombre: 'Trujillo', departamento: 'Norte del Valle', destacado: true },
  { nombre: 'Riofrío', departamento: 'Norte del Valle' },
  { nombre: 'Bugalagrande', departamento: 'Norte del Valle' },
  { nombre: 'Andalucía', departamento: 'Norte del Valle', destacado: true },
...
export const FAQS_CONCURSO = [
  {
    ...
    respuesta: 'Pueden participar músicos solistas, bandas, vocalistas, guitarristas y compositores residentes o nacidos en el Eje Cafetero (Risaralda, Caldas, Quindío) y Norte del Valle del Cauca (Cartago, El Cairo, Sevilla, Caicedonia, Roldanillo, Tuluá, etc.).',
  },
  {
